...
<section className="bg-gray-100 py-20">
    <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl font-bold mb-6 text-black" >We're launching soon</h1>
            <p className="text-gray-100 mb-12">Enter your email to be the first to know when we launch.</p>
            <form className="max-w-md mx-auto">
                <div className="flex items-center">
                    ...
                    <button type="submit" className="bg-red-400 text-white py-2 px-4 rounded-md hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-50">Subscribe</button>
                </div>
            </form>
        </div>
    </div>
...
<section className="bg-gray-200 py-20">
    <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-6 text-black">What to expect</h2>
        ...
        <div className="flex flex-wrap -mx-4 mt-12">
            <div className="w-full md:w-1/4 px-4 mb-8">
                <div className="rounded-md bg-white shadow-md p-8">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-black">Assignment Management</h3>
            ...
            <div className="w-full md:w-1/4 px-4 mb-8"> 
                <div className="rounded-md bg-white shadow-md p-8">
                    <img src="https://www.zoho.com/sites/zweb/images/creator/appdeck/assignment-tracker.svg" className='w-8 h-8'  alt="" />
                    < h3 className="text-2xl font-bold mb-4">Admission Management</h3>
                    <p className="text-gray-600 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis nec
                        orci quis justo aliquam euismod eget a leo.</p>
                </div>
            </div>
