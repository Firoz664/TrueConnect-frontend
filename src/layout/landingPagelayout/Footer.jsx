...
const Footer = () => {
  return (
    <div>
    <footer>
    <div class="bg-gray-100 py-4 text-gray-900">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <a href="" className='flex align-middle text-3xl text-black'>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-600">Company</h2>
            </div>
            <ul class="leading-8">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-600">Blog</h2>
            </div>
            <ul class="leading-8">
              <li><a href="#" class="hover:text-red-400">Getting Started With HTML and CSS</a></li>
              <li><a href="#" class="hover:text-red-400">What Is Flex And When to Use It?</a></li>
              <li><a href="#" class="hover:text-red-400">How TailwindCSS Can Help Your Productivity?</a></li>
              <li><a href="#" class="hover:text-red-400">5 Tips to Make Responsive Website</a></li>
              <li><a href="#" class="hover:text-red-400">See More</a></li>
            </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-red-600">Connect With Us</h2>
            </div>
    ...
    <div class="bg-red-600 py-4 text-black algin-items center" >
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full flex text-center sm:w-auto sm:text-left">
            Copyright © 2020
            <script>new Date().getFullYear()2020 && document.write("- " + new Date().getFullYear())</script>- 2022
            TrueConnect. All Rights Reserved.
          </div>
        </div>
      </div>
    </div>
