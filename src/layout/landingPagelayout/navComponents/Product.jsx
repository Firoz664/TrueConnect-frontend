            ...
            <div className="flex flex-wrap my-12">
                <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900 ">Increase sales</div>
                    </div>
                ...
                <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900">Enterprise-ready</div>
                    </div>
                ...
                <div className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900">Unlimited growth</div>
                    </div>
                ...
                <div className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900">Recommended by experts</div>
                    </div>
                ...
                <div className="w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900">Modern platform</div>
                    </div>
                ...
                <div className="w-full md:w-1/2 lg:w-1/3 p-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div className="ml-4 text-xl text-gray-900">Integrations</div>
                    </div>
